...
$(document).ready(function () {
    ...
    $('#ExpenseTableContainer').jtable({
        ...
        messages: {
            ...
            codSubtitulo: { title: 'SUBTÍTULO', width: '5%'},
            codItem: { title: 'ITEM', width: '5%'},
            codAsignacion: { title: 'ASIGNACIÓN', width: '5%'},
            codSubAsignacion: { title: 'SUBASIGNACIÓN', width: '5%'},
            descripcion: { title: 'DESCRIPCION', width: '15%'},
            ejercicio: { title: 'EJERCICIO', width: '5%'},
            folioAnio: { title: 'Nº DOCUMENTO', width: '5%'},
