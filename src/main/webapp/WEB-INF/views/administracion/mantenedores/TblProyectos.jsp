...
<head>
    ...
    <script src="${js}/mantenedores/tblProyectosBIP.js" type="text/javascript"></script>

</head>
<body onload="load();">
<div>
    <span style="display:none;">Estados:</span><select id="cbEstados" class="Selectano" style="display:none;"><option value="-1">Selec. Estado</option></select>
</div>
