...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
    ...
    <script type="text/javascript" src="/sicogen-mf/resources/js/asignacionTDR.js"></script>
...
<table class="adminlist" width="100%">
    <thead>
    <tr>
        <td colspan="20"><b>(*) Tipo Informe:</b><form:select id="contTipoInformes" path="listaInformesTDR">
            <form:options items="${listaInformesTDR}"  itemValue="id" itemLabel="nombre"/>
        </form:select> <b>&nbsp;(*) Ejercicio:</b>&nbsp;<form:select id="cbEjercicioAsigTDR" path="ejercicios" onchange="cargaPeriodoTDR(this.value);">
            <form:option value="-1" label="Seleccione Ejercicio"/>
             <form:options items="${ejercicios}" itemValue="ejercicioId" itemLabel="ejercicioNombre"/>
            </form:select><b>&nbsp;(*) Periodo:</b><select style="width: 227px;" name="contPeriodosTDR" id="contPeriodosTDR" class="combo">
                <option value="-1">Seleccione Per&iacute;odo</option>
            </select>&nbsp;&nbsp;<img style="width: 28px; height: 24px;" title="Catalogar" onclick="asignarTDR();" src="${images}asignar.png"/><br>
            Los Filtros marcados con * son obligatorios
        </td>
    </tr>
    </thead>
</table>
...
<table class="adminlist" width="100%">
    <thead>
          <tr>
            <td colspan="10"><div align="center"><span class="Estilo11"><b>Asignaci&oacute;n Tomas de Raz&oacute;n - Documentos SISTRADOC</b></span></div></td>
        </tr>
        <tr>
            <td width="30%" class="title-grid"><div align="center"><span class="Estilo11"><b>Entidad Remisora</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>Tipo Documento</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>N&ordm; Documento</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>Fecha Documento</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>Fecha Recepci&oacute;n CGR</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>Catalogado</b></span></div></td>
            <td width="10%" class="title-grid"><div align="center"><span class="Estilo11"><b>Asignar</b></span></div></td>
        </tr>
    </thead>
</table>
