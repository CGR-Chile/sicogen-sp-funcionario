...
public class DocumentoSistradocMapper extends BaseMapper implements RowMapper<InformeSistradocBO> {
    @Override
    public InformeSistradocBO mapRow(ResultSet rs, int i) throws SQLException {
        ...
        informeSistradocBO.setIdFileUpload(getString(rs, "FILEU_ID"));
        informeSistradocBO.setNombreArchivo(getString(rs, "NOMBRE"));
        informeSistradocBO.setIdEstadoSicogen(getString(rs, "ESTADO_ID"));
