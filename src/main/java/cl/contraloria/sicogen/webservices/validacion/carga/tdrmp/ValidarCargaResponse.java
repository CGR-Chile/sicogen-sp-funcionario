 ...
 *         &lt;element name="listaValidaciones" type="{http://www.cgr.cl/OSB/TDR/CargaArchivo/V1/DOM/ValidacionCarga}listaValidaciones" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ValidarCargaResponse {
    ...
    public String toString() {
        return "ValidarCargaResponse{" +
                "idFileUpload=" + idFileUpload +
                ", estado='" + estado + '\'' +
                ", mensajeCarga='" + mensajeCarga + '\'' +
                ", listaValidaciones=" + listaValidaciones +
                '}';
    }
}
