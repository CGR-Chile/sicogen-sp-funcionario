...
public class Error  implements java.io.Serializable {
    ...
    /**
     * Gets the codigoPartida value for this Error.
     * 
    ...
    /**
     * Sets the codigoPartida value for this Error.
     * 
     * @param codigoPartida
     */
    ...
    /**
     * Gets the codigoCapitulo value for this Error.
     * 
    ...
    /**
     * Sets the codigoCapitulo value for this Error.
     * 
    ...
    /**
     * Gets the codigoPrograma value for this Error.
     * 
    ...
    /**
     * Sets the codigoPrograma value for this Error.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.codigoPartida==null && other.getCodigoPartida()==null) || 
             (this.codigoPartida!=null &&
              this.codigoPartida.equals(other.getCodigoPartida()))) &&
            ((this.codigoCapitulo==null && other.getCodigoCapitulo()==null) || 
             (this.codigoCapitulo!=null &&
              this.codigoCapitulo.equals(other.getCodigoCapitulo()))) &&
            ((this.codigoPrograma==null && other.getCodigoPrograma()==null) || 
             (this.codigoPrograma!=null &&
              this.codigoPrograma.equals(other.getCodigoPrograma()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getCodigoPartida() != null) {
            _hashCode += getCodigoPartida().hashCode();
        }
        if (getCodigoCapitulo() != null) {
            _hashCode += getCodigoCapitulo().hashCode();
        }
        if (getCodigoPrograma() != null) {
            _hashCode += getCodigoPrograma().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "error"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codigoPartida");
        elemField.setXmlName(new javax.xml.namespace.QName("", "codigoPartida"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codigoCapitulo");
        elemField.setXmlName(new javax.xml.namespace.QName("", "codigoCapitulo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("codigoPrograma");
        elemField.setXmlName(new javax.xml.namespace.QName("", "codigoPrograma"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
