...
public class ValidarInformeSOAPQSServiceLocator extends org.apache.axis.client.Service implements ValidarInformeSOAPQSService {
    ...
    private String ValidarInformeSOAPQSPort_address = "http://sinapoc-PC:8011/Informes/SectorPublico/TDRII/v1/Validacion/Exposicion/PS/Servicio/validarInforme";
    ...
    public ValidarInforme getValidarInformeSOAPQSPort() throws javax.xml.rpc.ServiceException {
    ...
    public ValidarInforme getValidarInformeSOAPQSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ValidarInformeSOAPStub _stub = new ValidarInformeSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ValidarInforme.class.isAssignableFrom(serviceEndpointInterface)) {
                ValidarInformeSOAPStub _stub = new ValidarInformeSOAPStub(new java.net.URL(ValidarInformeSOAPQSPort_address), this);
                _stub.setPortName(getValidarInformeSOAPQSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/TDRII/V1/EXP/ValidacionInforme", "ValidarInformeSOAPQSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/TDRII/V1/EXP/ValidacionInforme", "ValidarInformeSOAPQSPort"));
        }
