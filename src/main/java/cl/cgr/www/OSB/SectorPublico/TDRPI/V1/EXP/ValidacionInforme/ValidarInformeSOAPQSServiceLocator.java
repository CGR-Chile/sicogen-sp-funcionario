...
public class ValidarInformeSOAPQSServiceLocator extends org.apache.axis.client.Service implements cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPQSService {
    ...
    private String ValidarInformeSOAPQSPort_address = "http://vserranoNtbk:7001/SP_Informe_PI/Sector_Publico/PI/V1/Exposicion/PS/Servicio/validarInforme";
    ...
    public cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme getValidarInformeSOAPQSPort() throws javax.xml.rpc.ServiceException {
    ...
    public cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme getValidarInformeSOAPQSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPStub _stub = new cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPStub _stub = new cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPStub(new java.net.URL(ValidarInformeSOAPQSPort_address), this);
                _stub.setPortName(getValidarInformeSOAPQSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "ValidarInformeSOAPQSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "ValidarInformeSOAPQSPort"));
        }
