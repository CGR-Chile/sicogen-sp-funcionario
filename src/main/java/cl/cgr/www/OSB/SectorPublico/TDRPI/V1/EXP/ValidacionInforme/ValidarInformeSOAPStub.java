...
public class ValidarInformeSOAPStub extends org.apache.axis.client.Stub implements cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "listaErrores"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "listaErrores"), cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error[].class, false, false);
    ...
    public ValidarInformeSOAPStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "error");
            cachedSerQNames.add(qName);
            cls = cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "listaErrores");
            cachedSerQNames.add(qName);
            cls = cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "error");
    ...
    public void validarInforme(java.math.BigDecimal idFileUpload, javax.xml.rpc.holders.StringHolder estado, javax.xml.rpc.holders.StringHolder mensaje, cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.holders.ListaErroresHolder listaErrores, javax.xml.rpc.holders.StringHolder excepcion, javax.xml.rpc.holders.StringHolder fechaInicio, javax.xml.rpc.holders.StringHolder fechaFin) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme/validarInforme");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.cgr.cl/OSB/SectorPublico/PI/V1/EXP/ValidacionInforme", "validarInforme"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {idFileUpload});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                listaErrores.value = (cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error[]) _output.get(new javax.xml.namespace.QName("", "listaErrores"));
            } catch (Exception _exception) {
                listaErrores.value = (cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error[]) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "listaErrores")), cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.Error[].class);
            }
            try {
