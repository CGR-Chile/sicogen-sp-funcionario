...
public class ValidarInformeProxy implements cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme {
  private String _endpoint = null;
  private cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme validarInforme = null;
  ...
  private void _initValidarInformeProxy() {
    try {
      validarInforme = (new cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPQSServiceLocator()).getValidarInformeSOAPQSPort();
  ...
  private void _initValidarInformeProxy(int idWS) {
    try {
      validarInforme = (new cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInformeSOAPQSServiceLocator(idWS)).getValidarInformeSOAPQSPort();
      if (validarInforme != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)validarInforme)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
  ...
  public cl.cgr.www.OSB.SectorPublico.PI.V1.EXP.ValidacionInforme.ValidarInforme getValidarInforme() {
    if (validarInforme == null)
      _initValidarInformeProxy();
